...
export default class Orc extends Race { // Dwarf herda alguns "comportamentos" d Race
  ...
  constructor(name: string, dexterity: number) {
    ...
    this.maxLifePoints = 74; // Defini o numero maximo de vidas em 80 points
    Orc.numberOfInstances += 1; // incrementa a cada vez que uma instancia for criada
  }
