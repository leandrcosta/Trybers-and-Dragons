# Trybers and Dragons
Projeto utilizado para aplicar os prícipios da arquitetura SOLID e os princípios de POO em uma estrutrua de jogos de interpretação de papéis, mais conhecidos como jogos RPG (Role Playing Game)

Foi desenvolvidos cada classe e interface utilizando o contexto abaixo, respeitando o que cada raça e personagem tem de atributo e a lógica o que cada um pode fazer no campo de batalha utilizando seus métodos.
...
#### <i>Texto a cima de autoria da Trybe</i>
...
- Clone o repositório:
`git clone git@github.com:leandrcosta/Trybers-and-Dragons.git`
...
<details>
  ...
  ⚠ Atenção ⚠ Não rode o comando npm audit fix! Ele atualiza várias dependências do projeto, e essa atualização gera conflitos.
</details>
<br>
